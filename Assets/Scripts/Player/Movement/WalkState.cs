...
public class WalkState : PlayerState
{
    ...
    public override void OnEnter() { Debug.Log("Entering Walk State"); }

    public override void OnUpdate()
    {
        Vector3 moveDirection = new Vector3(Input.GetAxis("Horizontal"), 0, Input.GetAxis("Vertical"));
        player.Move(moveDirection, player.playerAttributes.walkSpeed);
    ...
    public override void OnExit() { Debug.Log("Exiting Walk State"); }
}
